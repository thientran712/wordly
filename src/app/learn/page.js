...
export default function Home() {
  ...
  return (
    <>
      ...
      {toast && (
        <div 
          className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-white px-4 sm:px-6 py-2.5 sm:py-3.5 rounded-full font-semibold text-xs sm:text-sm z-[200] shadow-[0_20px_48px_rgba(45,27,78,0.12)] border-2 border-[--mint] text-[--grass] flex items-center gap-2 animate-fade-in max-w-[90vw] text-center"
        >
          {toast}
        </div>
      )}
